...
Resource Group: Enter rg-lab01-[yourname]. (e.g rg-lab01-hazekiah)
...
Click Save.
CRITICAL: Once saved, a Primary endpoint URL will appear (e.g., https://staticweblab01hazekiah.z13.web.core.windows.net/). Copy this URL. This is your website's address.
...
Fix: Storage names must be unique across all of Azure, not just your account. Add some random numbers to the end of your name (e.g., staticweblab01hazekiah).
